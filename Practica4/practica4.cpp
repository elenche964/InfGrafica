...
vector<_vertex3f> vCue;
vector<_vertex3f> vSup;
vector<_vertex3f> vInf;

//vectores de GLfloat que guarda los puntos
vector<double> verticesCue;
vector<double> verticesSup;
vector<double> verticesInf;
...
void initialize(void)
{
    ...
    _file_ply::read("lata-pinf", verticesInf);
    set_vertices(verticesInf, vInf);
    _file_ply::read("lata-psup", verticesSup);
    set_vertices(verticesSup, vSup);
    _file_ply::read("lata-pcue", verticesCue);
    set_vertices(verticesCue, vCue);
    
	Lata(vInf, vSup, vInf, NRev);
